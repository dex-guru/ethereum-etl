...
setup(
    ...
    install_requires=[
        ...
        "eth-utils==1.10",
        "eth-abi>=2.2.0,<3.0.0",
        # TODO: This has to be removed when "ModuleNotFoundError: No module named
        #  'eth_utils.toolz'" is fixed at eth-abi
    ...
    extras_require={
        "streaming": [
            ...
            "pg8000==1.16.6",
            # This library is a dependency for google-cloud-pubsub, starting from 0.3.22 it
            # requires Rust,
