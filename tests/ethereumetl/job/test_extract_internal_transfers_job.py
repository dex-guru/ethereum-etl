...
from ethereumetl.jobs.exporters.internal_transfers_item_exporter import internal_transfers_item_exporter
...
def read_resource(resource_group, file_name):
    return tests.resources.read_resource([INTERNAL_TRANSFER_RESOURCE_GROUP, resource_group], file_name)
